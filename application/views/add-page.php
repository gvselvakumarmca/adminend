...
<div class="row">
	<div class="col-xs-12">
		<form class="form-horizontal" name="createPage" id="createPage" action="<?php echo base_url('admin/savePage/');?>" method="post">
			<div class="form-group <?php if(form_error('pagename') != ''){echo 'has-error';}?>">
				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="pagename">Name *</label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="pagename" id="pagename" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('pagename');?>">
					<?php echo form_error('pagename', '<div class="help-block" for="pagename">','</div>');?>
				</div>
			</div>

			<div class="form-group <?php if(form_error('pagecontent') != ''){echo 'has-error';}?>">
				<label class="control-label col-md-3 col-sm-3 col-xs-12" for="pagecontent">Page Content *</label>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<textarea name="pagecontent" id="pagecontent" class="form-control col-md-7 col-xs-12" rows="20"><?php echo set_value('pagecontent');?></textarea>
					<?php echo form_error('pagecontent', '<div class="help-block" for="pagecontent">','</div>');?>
				</div>
			</div>
			...
			<div class="form-group <?php if(form_error('language') != ''){echo 'has-error';}?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					...
					<?php echo form_error('language', '<div class="help-block" for="language">','</div>');?>
				</div>
			</div>
...
$(function(){
	...
	var validate = $('#createPage').validate({
		rules: {
			pagename: {
				required: true
			},
