...
<div class="row">
	<div class="col-xs-12 News_div">
	 <?php
		...
		?>
		<form class="form-horizontal" name="createNews" id="createNews" action="<?php echo base_url('admin/savenews/'.$news['id']);?>" method="post">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<select class="form-control col-md-7 col-xs-12" name="lawyer" id="lawyer" data-placeholder="Select lawyer">
						...
						if(!empty($lawfirm))
						{
							...
							{
								?>
								<option value="<?php echo $lawyer['user_id'];?>" <?php if($lawyer['user_id'] == $news['lawyer_id']) echo 'selected'; ?>><?php echo $lawyer['lawyername']." / ".$lawyer['name'];?></option>
								<?php
							}
						}
						?>
			...
			<div class="form-group <?php if(form_error('title') != ''){echo 'has-error';}?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="title" id="title" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('title',$news['headline']);?>">
			...
			<div class="form-group <?php if(form_error('content') != ''){echo 'has-error';}?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<textarea name="content" id="content" class="form-control col-md-7 col-xs-12" rows="15"><?php echo set_value('content',$news['content']);?></textarea>
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<label><input type="checkbox" name="notify" id="notify" class="form-field-checkbox" value="1" <?php if($news['notify'] == 1) echo 'checked'; ?> ><span class="notify"> Notify me by email when a user comments on this article</span></label>
				</div>
			</div>
			<div class="form-group">
...
$(function(){
	...
	var id = <?php echo $news['id']; ?>;
	if (confirm('Are you sure you want to delete this mews?')) {
		$.ajax({
	            type: "POST",
