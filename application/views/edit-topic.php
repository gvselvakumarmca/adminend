...
<div class="row">
	<div class="col-xs-12 topic_div">
	 <?php
		...
		?>
		<form class="form-horizontal" name="createTopic" id="createTopic" action="<?php echo base_url('admin/saveTopic/'.$topic['id']);?>" method="post">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<select class="form-control col-md-7 col-xs-12" name="category" id="category" data-placeholder="Select category">
						...
						if(!empty($categories))
						{
							...
							{
								?>
								<option value="<?php echo $category['id'];?>" <?php if($category['id'] == $topic['category_id']) echo 'selected'; ?>><?php echo $category['name'];?></option>
								<?php
							}
						}
						?>
			...
			<div class="form-group <?php if(form_error('topic_name') != ''){echo 'has-error';}?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="topic_name" id="topic_name" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('topic_name', $topic['name']);?>">
			...
			<div class="form-group <?php if(form_error('url') != ''){echo 'has-error';}?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="url" id="url" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('url', $topic['url']);?>">
			...
			<div class="form-group <?php if(form_error('seo_text') != ''){echo 'has-error';}?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="seo_text" id="seo_text" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('seo_text', $topic['seo_text']);?>">
			...
			<div class="form-group <?php if(form_error('seo_text') != ''){echo 'has-error';}?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="search_keywords" id="search_keywords" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('search_keywords', $topic['search_keywords']);?>">
			...
			<div class="form-group <?php if(form_error('seo_text') != ''){echo 'has-error';}?>">
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="description" id="description" class="form-control col-md-7 col-xs-12" value="<?php echo set_value('description', $topic['description']);?>">
			...
			<div class="form-group">
				<div class="col-sm-offset-3 col-md-6 col-sm-6 col-xs-12">
					<div class="btn btn-default btn-lg fn_delete_btn"><i class="fa fa-trash"></i> Delete</div>
...
$(document).on("click",'.fn_delete_btn',function(){
	...
	if (confirm('Are you sure you want to delete this topic?')) {
		$.ajax({
	            ...
	            success: function(data) {
	            	location.href = "<?php echo base_url('admin/topics');?>";
